...
step1 = "<h3>"+_("Selection of the tile profile")+'''</h3>
	'''+_("mapCutr generates tiles for fast online map publishing.")+'''
	<p>
	...
	<blockquote>
	'''+_('Compatible with most existing WMS servers, with the OpenLayers base map, Google Earth and other applications using WGS84 coordinates .')+'''
...
<font size="-1">
<p>&nbsp;
<br>'''+_("Thank you for using mapCutr application.")+" "+_('This is an open-source project - you can help us to make it better.')+" "+_('Join us at <a href="https://github.com/stromberger/mapCutr">Github</a> to improve mapCutr!')+" "+_('')+'''
<p>
